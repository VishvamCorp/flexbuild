...
tim_vx: gpu_viv
	@[ $(SOCFAMILY) != IMX -o $(DISTROVARIANT) = tiny -o $(DISTROVARIANT) = base ] && exit || \
	 ...
	 cmake  -S $(MLDIR)/tim_vx \
		...
		-DCMAKE_C_FLAGS="--sysroot=$(RFSDIR) -I$(DESTDIR)/usr/include/aarch64-linux-gnu -I$(DESTDIR)/usr/include" \
		-DCMAKE_CXX_FLAGS="--sysroot=$(RFSDIR) -I$(DESTDIR)/usr/include/aarch64-linux-gnu -I$(DESTDIR)/usr/include" \
		-DCMAKE_SHARED_LINKER_FLAGS="-L$(DESTDIR)/usr/lib" \
		-DCONFIG=YOCTO \
